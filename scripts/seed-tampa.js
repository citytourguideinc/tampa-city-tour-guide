...
const ACTIVITIES = [
  ...
  { activity_name:'Tampa Bay History Center', category:'Things To Do', neighborhood:'Channelside', icon:'🏛', official_link:'https://tampabayhistorycenter.org/', short_summary:'Immersive exhibits spanning thousands of years of Tampa Bay history.', source_type:'curated', source_name:'Official', lat:27.9435, lng:-82.4549 },
  { activity_name:'Ybor City Historic District', category:'Things To Do', neighborhood:'Ybor City', icon:'🏗', official_link:'https://www.ybormuseum.org/', short_summary:'Tampa\'s iconic cigar-rolling district — history, nightlife, and Cuban cuisine.', source_type:'curated', source_name:'Official', lat:27.9609, lng:-82.4386 },
  ...
  { activity_name:'Amalie Arena', category:'Things To Do', neighborhood:'Channelside', icon:'🏟', official_link:'https://www.amaliearena.com/events', short_summary:'Home of the Tampa Bay Lightning — catch a hockey game or major concert.', source_type:'curated', source_name:'Official', lat:27.9428, lng:-82.4519 },
  ...
  { activity_name:'Armature Works', category:'Things To Do', neighborhood:'Heights', icon:'🍽', official_link:'https://www.armatureworks.com/all-events/', short_summary:'Stunning waterfront food hall, events, markets, and pop-ups at Tampa\'s coolest venue.', source_type:'curated', source_name:'Official', lat:27.9598, lng:-82.4649 },
  { activity_name:'The Florida Aquarium', category:'Things To Do', neighborhood:'Channelside', icon:'🐠', official_link:'https://www.flaquarium.org', short_summary:'Tampa\'s premier aquarium with marine life, dive shows, and conservation programs.', source_type:'curated', source_name:'Official', lat:27.9416, lng:-82.4499 },
  { activity_name:'ZooTampa at Lowry Park', category:'Things To Do', neighborhood:'North Tampa', icon:'🦁', official_link:'https://www.zootampa.org/', short_summary:'Award-winning zoo with 1,000+ animals, manatee exhibits, and safari experiences.', source_type:'curated', source_name:'Official', lat:27.9952, lng:-82.4726 },
  { activity_name:'Busch Gardens Tampa', category:'Things To Do', neighborhood:'Temple Terrace', icon:'🎢', official_link:'https://buschgardens.com/tampa/', short_summary:'Thrilling coasters, safari animals, live entertainment, and world-class rides.', source_type:'curated', source_name:'Official', lat:28.0378, lng:-82.4208 },
  { activity_name:'Henry B. Plant Museum', category:'Things To Do', neighborhood:'Downtown', icon:'🏰', official_link:'https://www.plantmuseum.com/', short_summary:'Gilded Age grandeur inside a National Historic Landmark on the UT campus.', source_type:'curated', source_name:'Official', lat:27.9437, lng:-82.4654 },
  { activity_name:'Tampa Riverwalk', category:'Things To Do', neighborhood:'Downtown', icon:'🌊', official_link:'https://thetampariverwalk.com/', short_summary:'Beautiful 2.6-mile waterfront promenade linking parks, museums, restaurants, and bars.', source_type:'curated', source_name:'Official', lat:27.9476, lng:-82.4620 },
  { activity_name:'Glazer Children\'s Museum', category:'Things To Do', neighborhood:'Downtown', icon:'👶', official_link:'https://www.glazermuseum.org/', short_summary:'Hands-on interactive museum for kids with 170+ exhibits across 53,000 sq ft.', source_type:'curated', source_name:'Official', lat:27.9477, lng:-82.4588 },
  { activity_name:'Florida State Parks', category:'Things To Do', neighborhood:'City-wide', icon:'🌲', official_link:'https://www.floridastateparks.org/', short_summary:'Hike, camp, kayak, and explore Florida\'s stunning state parks near Tampa Bay.', source_type:'curated', source_name:'Official' },
  // ── Beaches & Outdoors ────────────────────────────────────────
  { activity_name:'Clearwater Beach', category:'Beaches & Outdoors', neighborhood:'Clearwater', icon:'🏖', official_link:'https://www.visitstpeteclearwater.com/clearwater-beach', short_summary:'Consistently ranked America\'s #1 beach — white sand, crystal water, and epic sunsets.', source_type:'curated', source_name:'Official', lat:27.9778, lng:-82.8275 },
  { activity_name:'St. Pete Beach', category:'Beaches & Outdoors', neighborhood:'St. Pete Beach', icon:'🌅', official_link:'https://www.visitstpeteclearwater.com/st-pete-beach', short_summary:'Seven-mile barrier island beach with colorful resorts, shops, and restaurants.', source_type:'curated', source_name:'Official', lat:27.7225, lng:-82.7415 },
  { activity_name:'Caladesi Island State Park', category:'Beaches & Outdoors', neighborhood:'Dunedin', icon:'🏝', official_link:'https://www.floridastateparks.org/caladesiisland', short_summary:'Pristine undeveloped island beach accessible only by ferry — Florida at its best.', source_type:'curated', source_name:'Official', lat:28.0489, lng:-82.8195 },
  { activity_name:'Hillsborough River State Park', category:'Beaches & Outdoors', neighborhood:'Thonotosassa', icon:'🚣', official_link:'https://www.floridastateparks.org/hillsboroughriver', short_summary:'Kayak, canoe, swim, and hike through lush Florida wilderness just north of Tampa.', source_type:'curated', source_name:'Official', lat:28.1458, lng:-82.2325 },
  { activity_name:'Ballast Point Park', category:'Beaches & Outdoors', neighborhood:'South Tampa', icon:'🎣', official_link:'https://www.tampa.gov/parks-and-recreation/featured-parks/ballast-point', short_summary:'Popular South Tampa waterfront park with fishing pier, playground, and bay views.', source_type:'curated', source_name:'Official', lat:27.9044, lng:-82.4867 },
  // ── Restaurants & Dining ──────────────────────────────────────
  { activity_name:'Columbia Restaurant Ybor City', category:'Restaurants & Dining', neighborhood:'Ybor City', icon:'🥘', official_link:'https://www.columbiarestaurant.com/ybor-city/', short_summary:'Florida\'s oldest restaurant (1905) — legendary Cuban cuisine, flamenco shows, and history.', source_type:'curated', source_name:'Official', lat:27.9605, lng:-82.4355 },
  { activity_name:'Ulele Restaurant', category:'Restaurants & Dining', neighborhood:'Heights', icon:'🌽', official_link:'https://ulele.com/', short_summary:'Native Florida cuisine in a stunning 1903 water works building on the Hillsborough River.', source_type:'curated', source_name:'Official', lat:27.9570, lng:-82.4667 },
  { activity_name:'Bern\'s Steakhouse', category:'Restaurants & Dining', neighborhood:'Hyde Park', icon:'🥩', official_link:'https://www.bernssteakhouse.com/', short_summary:'Legendary Tampa institution — world\'s largest wine list and dry-aged steaks since 1956.', source_type:'curated', source_name:'Official', lat:27.9305, lng:-82.4835 },
  { activity_name:'Oxford Exchange', category:'Restaurants & Dining', neighborhood:'Hyde Park', icon:'☕', official_link:'https://oxfordexchange.com/', short_summary:'Beautifully designed marketplace, restaurant, and café — Tampa\'s most instagrammable brunch spot.', source_type:'curated', source_name:'Official', lat:27.9409, lng:-82.4806 },
  { activity_name:'Rooster & the Till', category:'Restaurants & Dining', neighborhood:'Seminole Heights', icon:'🍳', official_link:'https://www.roosterandthetill.com/', short_summary:'James Beard-nominated neighborhood bistro in Seminole Heights with creative New American fare.', source_type:'curated', source_name:'Official', lat:27.9878, lng:-82.4577 },
  { activity_name:'Ella\'s Americana Folk Art Cafe', category:'Restaurants & Dining', neighborhood:'Seminole Heights', icon:'🎸', official_link:'https://www.ellasfolkartcafe.com/', short_summary:'Eclectic Seminole Heights gem with live music, folk art décor, and amazing burgers.', source_type:'curated', source_name:'Official', lat:27.9888, lng:-82.4598 },
  // ── Nightlife ─────────────────────────────────────────────────
  { activity_name:'Ybor City Nightlife', category:'Nightlife', neighborhood:'Ybor City', icon:'🌙', official_link:'https://www.ybormuseum.org/', short_summary:'Tampa\'s electric entertainment district — clubs, bars, live music, and late-night eats.', source_type:'curated', source_name:'Official', lat:27.9609, lng:-82.4386 },
  { activity_name:'SoHo District Bars', category:'Nightlife', neighborhood:'Hyde Park', icon:'🍹', official_link:'https://www.visittampabay.com/', short_summary:'South Howard Ave\'s walkable stretch of trendy restaurants, rooftop bars, and nightlife.', source_type:'curated', source_name:'Official', lat:27.9351, lng:-82.4894 },
  { activity_name:'Seminole Heights Bar Scene', category:'Nightlife', neighborhood:'Seminole Heights', icon:'🍺', official_link:'https://thatssotampa.com/', short_summary:'Tampa\'s hippest neighborhood with craft breweries, cocktail bars, and live music venues.', source_type:'curated', source_name:'Official', lat:27.9878, lng:-82.4577 },
  { activity_name:'Heights Rooftop at Armature Works', category:'Nightlife', neighborhood:'Heights', icon:'🥂', official_link:'https://www.armatureworks.com/', short_summary:'Tampa\'s most scenic rooftop bar with panoramic river views, craft cocktails, and sunsets.', source_type:'curated', source_name:'Official', lat:27.9598, lng:-82.4649 },
  // ── Sports & Entertainment ────────────────────────────────────
  { activity_name:'Tampa Bay Lightning Games', category:'Sports & Entertainment', neighborhood:'Channelside', icon:'⚡', official_link:'https://www.nhl.com/lightning/schedule', short_summary:'Cheer on the 3x Stanley Cup champions at Amalie Arena — one of Tampa\'s best experiences.', source_type:'curated', source_name:'Official', lat:27.9428, lng:-82.4519 },
  { activity_name:'Tampa Bay Buccaneers Games', category:'Sports & Entertainment', neighborhood:'Downtown', icon:'🏈', official_link:'https://www.buccaneers.com/schedule/', short_summary:'NFL football at Raymond James Stadium — home of the Super Bowl champion Buccaneers.', source_type:'curated', source_name:'Official', lat:27.9758, lng:-82.5033 },
  { activity_name:'Tampa Bay Rays Games', category:'Sports & Entertainment', neighborhood:'St. Petersburg', icon:'⚾', official_link:'https://www.mlb.com/rays/schedule', short_summary:'MLB baseball at Tropicana Field — fun for the whole family with affordable tickets.', source_type:'curated', source_name:'Official', lat:27.7683, lng:-82.6534 },
  { activity_name:'Tampa Bay Rowdies Soccer', category:'Sports & Entertainment', neighborhood:'St. Petersburg', icon:'⚽', official_link:'https://www.rowdiessoccer.com/schedule', short_summary:'USL Championship soccer at Al Lang Stadium on the beautiful St. Pete waterfront.', source_type:'curated', source_name:'Official', lat:27.7724, lng:-82.6310 },
  // ── Shopping ─────────────────────────────────────────────────
  { activity_name:'Hyde Park Village', category:'Shopping', neighborhood:'Hyde Park', icon:'🛍', official_link:'https://www.hydeparkvillage.com/', short_summary:'Charming open-air shopping center with boutiques, restaurants, and weekend events.', source_type:'curated', source_name:'Official', lat:27.9364, lng:-82.4860 },
  ...
  { activity_name:'Creative Loafing Tampa Events', category:'Events Calendar', neighborhood:'City-wide', icon:'📰', official_link:'https://cltampa.com/', short_summary:'Arts, culture, music, food, and nightlife from Tampa\'s best alternative weekly.', source_type:'curated', source_name:'Local Media' },
  ...
  { activity_name:'Tampa Bay Food & Wine Festival', category:'Events Calendar', neighborhood:'City-wide', icon:'🍷', official_link:'https://tampabaywff.com/', short_summary:'Annual celebration of local chefs, restaurants, and vintners across Tampa Bay — April 7-11, 2026.', source_type:'curated', source_name:'Official' },
  // ── Tours & Activities ────────────────────────────────────────
  ...
  { activity_name:'Visit Tampa Bay Tours', category:'Tours & Activities', neighborhood:'City-wide', icon:'🌴', official_link:'https://www.visittampabay.com/things-to-do/tours/', short_summary:'Official visitor guide to Tampa Bay tours — water adventures, cultural walks, and more.', source_type:'curated', source_name:'Official' },
  // ── Deals & Discounts ─────────────────────────────────────────
  ...
  { activity_name:'Visit Tampa Bay Deals', category:'Deals & Discounts', neighborhood:'City-wide', icon:'🌴', official_link:'https://www.visittampabay.com/unlock-deals/', short_summary:'Exclusive visitor discounts and offers from the official Tampa Bay tourism board.', source_type:'curated', source_name:'Official' },
  { activity_name:'Florida Resident Discounts', category:'Deals & Discounts', neighborhood:'City-wide', icon:'🌴', official_link:'https://www.floridastateparks.org/', short_summary:'Florida residents save on state parks, attractions, and local offers year-round.', source_type:'curated', source_name:'Official' },
  // ── Wellness ──────────────────────────────────────────────────
  { activity_name:'Tampa Yoga Studios', category:'Wellness', neighborhood:'City-wide', icon:'🧘', official_link:'https://thatssotampa.com/', short_summary:'Discover Tampa\'s best yoga, pilates, and mindfulness studios from South Tampa to Seminole Heights.', source_type:'curated', source_name:'Local Media' },
  { activity_name:'Float Tampa', category:'Wellness', neighborhood:'South Tampa', icon:'💧', official_link:'https://floattampa.com/', short_summary:'Sensory deprivation float therapy for deep relaxation, recovery, and mental clarity.', source_type:'curated', source_name:'Official' },
